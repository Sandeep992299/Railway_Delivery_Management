...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="{{ url('/customer-parcel') }}">Customer Parcel Management</a></li>
                <li><a href="{{ url('/gov-stock') }}">Government Stock Management</a></li>
                <li><a href="{{ url('/tracking') }}">Parcel Tracking</a></li>
                <li><a href="{{ url('/fuel') }}">Fuel Stock</a></li>
    ...
    <div class="main-content">
        ...
        <section class="cta-buttons">
            <button onclick="location.href='{{ url('/tracking') }}'" class="cta-button track-button">Track Your Parcel <span class="arrow">→</span></button>
        ...
        <section class="testimonials">
            ...
            <div class="testimonial-slider">
                <div class="testimonial">
                    <img src="{{ asset('images/images (2).jpg') }}" alt="Customer 1" class="customer-photo">
                ...
                <div class="testimonial">
                    <img src="{{ asset('images/images (2).jpg') }}" alt="Customer 2" class="customer-photo">
                    <p>"The best train service I've ever experienced. Reliable and punctual!"</p>
                    <h4>- Jane Doe</h4>
                    <div class="stars" data-rating="5"></div>
                </div>
                <div class="testimonial">
                    <img src="{{ asset('images/images (2).jpg') }}" alt="Customer 3" class="customer-photo">
